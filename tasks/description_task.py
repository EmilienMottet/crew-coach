...
def create_description_task(agent, activity_data: Dict[str, Any]) -> Task:
    ...
    After retrieving and analyzing all data, you MUST output a JSON object with this exact structure:
    {{
    ...
    return Task(
        ...
        agent=agent,
        expected_output=(
            "A JSON object (not wrapped in markdown) with exactly four fields:\n"
            "1. 'title': concise activity title with emoji (≤50 chars)\n"
            "2. 'description': detailed description with metrics and 'Generated by AI' watermark\n"
            "3. 'workout_type': workout classification (e.g., 'Tempo', 'Intervals', 'Easy Ride')\n"
            "4. 'key_metrics': dictionary of key metrics as string key-value pairs\n"
            "Example: {\"title\": \"🚴 Title\", \"description\": \"Text\\n\\nGenerated by AI\", \"workout_type\": \"Tempo\", \"key_metrics\": {}}\n"
