...
def create_description_reviewer_agent(llm: Any) -> Agent:
    ...
    return Agent(
        ...
        5. Create an engaging title (≤50 characters)
        6. Write a compelling description (≤500 characters)

        TITLE GUIDELINES (≤50 chars):
        - Include 1-2 relevant emojis (🏃 🚴 💪 etc.)
        - Highlight the workout type or key achievement
        - Keep it punchy and natural

        DESCRIPTION GUIDELINES (≤500 chars):
        ...
        - Include CORE temp if significant (≥39°C or rise ≥1.5°C)
        - Close with a feeling/mindset note
        - End with "Generated by AI" on a new line

        CORE TEMPERATURE INTERPRETATION:
        - ≥39.5°C: Critical thermal stress - always mention
        - ≥39.0°C: High thermal stress - mention in hot conditions
        - Rise ≥1.5°C: Significant elevation - mention
